////////////////////////////////////////////////////////////////////////////////////////////////////////////
// This is *almost* the same file as https://github.com/jtuitman/Coleman/blob/master/auxpolys.m
// One change: logarithm function below 
////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
log:=function(p,x)
  if Type(x) eq RngPadElt or Type(x) eq FldPadElt then
        return Log(x); // Uses Magma's built-in Iwasawa logarithm
  end if;
