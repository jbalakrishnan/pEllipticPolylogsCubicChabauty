...
//
// This is Example 6.4 of [BBD], which is the example of E = 389.a1 and p = 5.
///////////////////////////////////////////////////////////////////////////////////
...
//Input:
Q:=y^2 - (x^3 - 3024*x + 46224); //389.a1 with completed cube.
p:=5;
N:=50;
...
Q1:=E![-1,1];  //389.a1 generator
Q2:=E![0,-1];  //389.a1 generator
...
c:=K!cis[7];
print "c = ", c;
print "c1, c2, ..., c6 = ", [K!cis[1], K!cis[2], K!cis[3], K!cis[4], K!cis[5], K!cis[6]];
