////////////////////////////////////////////////////////////////////////////////////////////////////////////
// This is the same file as https://github.com/jtuitman/Coleman/blob/master/applications.m
////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
vanishing_differentials:=function(points,data:e:=1);
  ...
  // Compute a basis for the space of regular 1-forms on which the 
  // integrals vanish between all differences of rational points.
  // NOTE: this does not necessarily determine the full space of
  // annhilating differentials, unless one knows the rank.
  ...
  for i:=1 to #points do
    for j:=i+1 to #points do
        if i ne j then
        Ci,Ni:=coleman_integrals_on_basis(points[i],points[j],data:e:=e);
  ...
  M:=ZeroMatrix(K,g,Integers()!(#points*(#points-1)/2));
  for i:=1 to g do
      for j:=1 to Integers()!(#points*(#points-1)/2) do
...
effective_chabauty:=function(data:Qpoints:=[],bound:=0,e:=1,ann:=[]);
